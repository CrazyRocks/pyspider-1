...
@click.version_option(version='0.3.6', prog_name='pyspider')
@click.pass_context
def cli(ctx, **kwargs):
    """
...
def webui(ctx, host, port, cdn, scheduler_rpc, fetcher_rpc, max_rate, max_burst,
    ...
    print max_rate, max_burst, username, password
...
def bench(ctx, fetcher_num, processor_num, result_worker_num, run_in, total, show,
    ...
    """
    from libs import bench
    from webui import bench_test
...
def main():
    print 'BUPT pyspider is running...'
    cli()
